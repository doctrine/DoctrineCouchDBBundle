...
use Symfony\Component\Console\Input\InputArgument,
    ...
    Doctrine\CouchDB\Tools\Console\Command\ViewCleanupCommand AS DoctrineViewCleanupCommand;

class ViewCleanupCommand extends DoctrineViewCleanupCommand
{
    protected function configure()
    {
        parent::configure();
        
        $this->setName('doctrine:couchdb:maintenance:view-cleanup')
